...
abstract class AppLocalizations {
  ...
  /// No description provided for @customLabCard.
  ///
  /// In en, this message translates to:
  /// **'Custom Lab'**
  String get customLabCard;

  /// No description provided for @sensorLabCompanion.
  ///
  /// In en, this message translates to:
  /// **'Sensor Lab - Your Personal Lab Companion'**
  String get sensorLabCompanion;

  /// No description provided for @quickAccessViewAll.
  ///
  /// In en, this message translates to:
  /// **'Quick Access - View All'**
  String get quickAccessViewAll;

  /// No description provided for @magnetometerMax.
  ///
  /// In en, this message translates to:
  /// **'Max'**
  String get magnetometerMax;

  /// No description provided for @proximityMainCircle.
  ///
  /// In en, this message translates to:
  /// **'Proximity'**
  String get proximityMainCircle;

  /// No description provided for @pedometerSedentary.
  ///
  /// In en, this message translates to:
  /// **'Sedentary'**
  String get pedometerSedentary;
  ...
  /// No description provided for @userOnboardingLanguage.
  ///
  /// In en, this message translates to:
  /// **'Language'**
  String get userOnboardingLanguage;

  /// No description provided for @userOnboardingChangeLanguage.
  ///
  /// In en, this message translates to:
  /// **'Change Language'**
  String get userOnboardingChangeLanguage;

  /// No description provided for @userOnboardingWelcome.
  ///
  /// In en, this message translates to:
  /// **'Welcome to SensorLab!'**
  String get userOnboardingWelcome;

  /// No description provided for @userOnboardingGetStarted.
  ///
  /// In en, this message translates to:
  /// **'Get Started'**
  String get userOnboardingGetStarted;

  /// No description provided for @userOnboardingNext.
  ///
  /// In en, this message translates to:
  /// **'Next'**
  String get userOnboardingNext;

  /// No description provided for @userOnboardingPrevious.
  ///
  /// In en, this message translates to:
  /// **'Previous'**
  String get userOnboardingPrevious;

  /// No description provided for @userOnboardingSkip.
  ///
  /// In en, this message translates to:
  /// **'Skip'**
  String get userOnboardingSkip;

  /// No description provided for @userOnboardingFinish.
  ///
  /// In en, this message translates to:
  /// **'Finish'**
  String get userOnboardingFinish;

  /// No description provided for @onboardingTitleSuperpowers.
  ///
  /// In en, this message translates to:
  /// **'Your Phone Has Superpowers'**
  String get onboardingTitleSuperpowers;

  /// No description provided for @onboardingDescSuperpowers.
  ///
  /// In en, this message translates to:
  /// **'It\'s not just a phone; it\'s a powerful sensor suite. Let\'s uncover the hidden genius you hold in your hand.'**
  String get onboardingDescSuperpowers;

  /// No description provided for @onboardingTitleSenseWorld.
  ///
  /// In en, this message translates to:
  /// **'Sense the Unseen World'**
  String get onboardingTitleSenseWorld;

  /// No description provided for @onboardingDescSenseWorld.
  ///
  /// In en, this message translates to:
  /// **'Measure sound, light, magnetism, and motion. See your environment in a way you never have before.'**
  String get onboardingDescSenseWorld;

  /// No description provided for @onboardingTitleLaboratory.
  ///
  /// In en, this message translates to:
  /// **'Your Pocket-Sized Laboratory'**
  String get onboardingTitleLaboratory;

  /// No description provided for @onboardingDescLaboratory.
  ///
  /// In en, this message translates to:
  /// **'From simple curiosity to serious experiments, build your custom lab to discover, record, and understand the world.'**
  String get onboardingDescLaboratory;

  /// No description provided for @onboardingTitleDiscovery.
  ///
  /// In en, this message translates to:
  /// **'Begin Your Journey of Discovery'**
  String get onboardingTitleDiscovery;

  /// No description provided for @onboardingDescDiscovery.
  ///
  /// In en, this message translates to:
  /// **'All set. Start exploring, experimenting, and seeing the world differently. Your lab awaits.'**
  String get onboardingDescDiscovery;
}
