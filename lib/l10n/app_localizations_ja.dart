...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get onboardingTitleSuperpowers => 'あなたのスマートフォンはスーパーパワーを持っています';

  @override
  String get onboardingDescSuperpowers => 'これは単なる電話ではなく、強力なセンサー群です。あなたが手にしている隠れた天才を発見しましょう。';

  @override
  String get onboardingTitleSenseWorld => '見えない世界を感じる';

  @override
  String get onboardingDescSenseWorld => '音、光、磁気、動きを測定します。今までにない方法で環境を見てみましょう。';

  @override
  String get onboardingTitleLaboratory => 'ポケットサイズのラボ';

  @override
  String get onboardingDescLaboratory => '好奇心から本格的な実験まで、カスタムラボを作って世界を発見・記録・理解しましょう。';

  @override
  String get onboardingTitleDiscovery => '発見の旅を始めましょう';

  @override
  String get onboardingDescDiscovery => '準備完了。探索、実験、そして世界を違った視点で見始めましょう。あなたのラボが待っています。';
}
